...
var BlockedEnchants = map[string][]string{
...
var IgnoredEnchants = map[string]int{
	"scavenger": 5,
}

var StackingEnchants = []string{"expertise", "compact", "cultivating", "champion", "hecatomb"}

var IgnoreSilex = []string{"promising_spade"}

var MasterStars = []string{"first_master_star", "second_master_star", "third_master_star", "fourth_master_star", "fifth_master_star"}

var ValidRunes = []string{
	"MUSIC_1", "MUSIC_2", "MUSIC_3",
	"ENCHANT_1", "ENCHANT_2", "ENCHANT_3",
	"GRAND_SEARING_3", "SPELLBOUND_3", "GRAND_FREEZING_3", "PRIMAL_FEAR_3",
}

var AllowedRecombTypes = []string{"ACCESSORY", "NECKLACE", "GLOVES", "BRACELET", "BELT", "CLOAK"}
var AllowedRecombIds = []string{
...
var AttributesBaseCosts = map[string]string{
...
var PickonimbusDurability = 5000

var SpecialEnchantmentMatches = map[string]string{
